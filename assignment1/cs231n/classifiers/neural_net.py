rfom __future__ import print_function
...
#         scores -= np.max(scores, axis=1, keepdims=True)
        ...
        loss_vector = exp_scores[range(N),y] / np.sum(exp_scores,axis = 1)
    ...
    def predict(self, X):
        ...
        a2 = np.maximum(z2,0)
        a3 = a2.dot(self.params['W2']) + self.params['b2']
        y_pred = np.argsort(a3,axis = 1)[:,-1]
